...
import Navbar from '../sections/FormNav';
...
export default function RegistrationForm() {
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-blue-700">
      <Navbar/>
      <h1 className="text-3xl font-bold text-white mb-10 lg:mt-52 text-center border-2 border-white/20 p-4 rounded-3xl shadow-lg">
      ...
      <div className="w-full  space-y-10">
        ...
        <Card 
          ref={cardRefs[1]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl mr-0 md:mr-32 ml-auto rounded-3xl ${currentCard === 1 ? 'scale-100 opacity-100' : currentCard < 1 ? 'scale-95 opacity-70' : 'scale-95 opacity-90'}`}
        >
          <CardContent className="pt-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  onChange={handleInputChange} 
                  className={`bg-white/30 text-white placeholder:text-white  ${errors.highSchoolName ? 'border-red-400' : 'border-white/30'}`}
              ...
              <div className="space-y-2">
                ...
                >
                 <SelectTrigger className={`bg-white/30 !text-white placeholder:text-white  ${errors.state ? 'border-red-400' : 'border-white/30'}`}>
  <SelectValue 
  ...
  />
        ...
        <Card 
          ref={cardRefs[2]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl ml-0 md:ml-32 rounded-3xl ${currentCard === 2 ? 'scale-100 opacity-100' : currentCard < 2 ? 'scale-95 opacity-70' : 'scale-95 opacity-90'}`}
        >
          <CardContent className="pt-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className={` text-blue  placeholder:text-white  ${errors.race ? 'border-red-400' : 'border-white/30'}`}>
                    <SelectValue  className="text-white" placeholder="Select race" />
                  </SelectTrigger>
                  <SelectContent>
        ...
        <Card 
          ref={cardRefs[3]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl mr-0 md:mr-32 ml-auto rounded-3xl ${currentCard === 3 ? 'scale-100 opacity-100' : 'scale-95 opacity-70'}`}
        >
          <CardContent className="pt-6">
