...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50">
      <nav
        className={cn(
          'flex items-center justify-between mx-auto max-w-7xl p-3 rounded-full transition-all duration-300',
          'border shadow-lg backdrop-blur-lg',
          scrolled ? 'bg-white/10 border-white/20' : 'bg-transparent border-transparent',
          'mx-4 sm:mx-6 lg:mx-8 mt-4'
        )}
      >
        {/* Logo - Left Side */}
        ...
        {isMenuOpen && (
          <div
            className={cn(
              ...
              'bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-4',
              'flex flex-col gap-2'
            )}
          >
            {menuItems.map((item) => (
