  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 py-4 fixed top-0 z-50 ">
      ...
      >
        ...
        <div
          className="
            lg:flex items-center gap-4 hidden  bg-transparent backdrop-blur-sm rounded-3xl px-6 py-2 border border-white/30
          "
        >
          {menuItems.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  'text-blue-900 px-3 py-2 rounded-lg text-sm font-medium',
