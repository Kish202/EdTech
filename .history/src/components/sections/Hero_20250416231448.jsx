    ...
    <div className="w-full min-h-screen bg-gradient-to-br from-white via-blue-50 to-green-50 overflow-hidden">
      <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full lg:w-1/2 space-y-6 z-10 lg:ml-28 lg:pl-10 ">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-blue-800 via-blue-600 to-green-600 bg-clip-text text-transparent leading-tight p">
