...
const ProcessSection = () => {
  ...
  return (
    <div className="w-full py-10 bg-gradient-to-br from-white via-blue-50/70 to-green-50/70">
      <div className="container mx-auto px-4">
        {/* Headline */}
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-700 via-blue-600 to-green-600 bg-clip-text text-transparent mb-2 pb-10 ">
            Your Journey to the Perfect College
          </h2>
          <p className="text-lg text-blue-800/70 max-w-2xl mx-auto p-2">
      ...
      <div ref={ref} className="w-full">
        <motion.div
          ...
          className={`w-full md:w-1/2 ${
            step.alignment === "left" ? "ml-6  md:pr-16 md:pl-10" : "ml-auto mr-6 md:pl-16 md:pr-10"
