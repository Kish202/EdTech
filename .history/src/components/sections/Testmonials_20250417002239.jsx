    ...
    <div className="w-full py-16 bg-gradient-to-br from-blue-50 via-white to-green-50 overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className=" inline-block text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-700 to-green-600 bg-clip-text text-transparent mb-4 hover:border-b-2 border-blue-700  ">
