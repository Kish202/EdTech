    ...
    <div className="w-full py-16 bg-gradient-to-br from-blue-50 via-white to-green-50 overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="relative px-8">
          {/* Custom navigation arrows - positioned further from cards */}
          <button 
          ...
          <div className="mx-4">
            <Slider ref={sliderRef} {...settings} className="testimonial-slider">
              {testimonials.map((testimonial) => (
                <div key={testimonial.id} className="px-">
                  <div className="h-full transform transition-all duration-300 hover:scale-105 hover:rotate-1 perspective-1000">
                    <Card className="h-full bg-white/70 backdrop-blur-sm border border-blue-200/50 shadow-lg transition-all duration-300 overflow-hidden">
