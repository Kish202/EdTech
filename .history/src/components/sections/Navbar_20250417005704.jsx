...
const Navbar = () => {
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 py-4 fixed top-0 z-50 bg-white/10 backdrop-blur-lg border-b border-white/20 shadow-lg transition-all duration-300 mb-20 lg:">
      <nav
        className={cn(
