      ...
      <div ref={ref} className="w-full">
        <div className={`w-full flex ${step.alignment === "left" ? "justify-start" : "justify-end"}`}>
          <motion.div
            ...
            animate={controls}
            variants={variants}
            className={`w-full md:w-1/2 flex items-center gap-6 ${
              step.alignment === "left" ? "flex-row" : "flex-row-reverse"
            }`}
          >
            {/* Number Circle */}
            ...
            <div className="flex-grow">
              <div className="bg-white/60 backdrop-blur-sm border border-blue-100 rounded-xl p-6 mxshadow-md hover:shadow-lg transition-shadow duration-300 relative">
                {/* Connecting line to circle */}
                <div
                  className={`absolute top-1/2 ${
                    step.alignment === "left" ? "left-0 -translate-x-full" : "right-0 translate-x-full"
