      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          <button 
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/80 rounded-full p-4 shadow-md hover:bg-blue-50 transition-colors -ml-2 md:ml-2"
          ...
          <button 
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/80 rounded-full p-4 shadow-md hover:bg-blue-50 transition-colors -mr-2 md:mr-2"
