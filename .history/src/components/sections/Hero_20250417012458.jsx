...
import second from '@/assets/happy.jpg';
const HeroSection = () => {
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full lg:w-1/2 flex justify-center items-center lg:mr-16">
          ...
          >
            ...
            <Card className="relative h-[500px] w-full overflow-hidden border border-white/20 backdrop-blur-sm bg-white/30 shadow-xl">
              <CardContent className="p-0 h-full">
                ...
                <div className={`absolute inset-0 transition-opacity duration-500 ${isHovered ? 'opacity-0' : 'opacity-100'}`}>
                  <div className="h-full w-full bg-gray-200 flex items-center justify-center">
                    ...
                    <img src={first} alt="" className="w-full h-full object-cover filter grayscale"/>
                  </div>
                </div>
