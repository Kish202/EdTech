    ...
    <div className="w-full py-20 bg-gradient-to-br from-white via-blue-50/70 to-green-50/70">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-36">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-700 via-blue-600 to-green-600 bg-clip-text text-transparent mb-1 pb-10 6">
