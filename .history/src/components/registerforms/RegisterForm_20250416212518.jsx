...
const RegisterForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-200/50 to-green-100/50 p-4">
      <div
        className={cn(
          'w-full max-w-md p-3 rounded-3xl',
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <Input
              ...
              className="bg-white/5 border-white/20 text-blue-950 placeholder:text-blue-500/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              required
            />
          </div>
          <div>
