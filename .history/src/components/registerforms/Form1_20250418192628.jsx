...
export default function RegistrationForm() {
  ...
  />
        ...
        <Card 
          ref={cardRefs[2]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl ml-0 md:ml-32 rounded-3xl ${currentCard === 2 ? 'scale-100 opacity-100' : currentCard < 2 ? 'scale-95 opacity-70' : 'scale-95 opacity-70'}`}
        >
          <CardContent className="pt-6">
