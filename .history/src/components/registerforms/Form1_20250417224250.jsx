  ...
  return (
    <div className="min-h-screen flex flex-col items-center  p-6 bg-gradient-to-br from-blue-600 to-green-950">
      ...
      <div className="w-full  space-y-12">
        ...
        <Card 
          ref={cardRefs[0]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl  justify-start mdml-0 rounded-3xl ${currentCard === 0 ? 'scale-100 opacity-100' : 'scale-95 opacity-70'}`}
        >
