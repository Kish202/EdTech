...
export default function RegistrationForm() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-br from-blue-600 to-green-950">
      ...
      <div className="w-full  space-y-10">
        ...
        <Card 
          ref={cardRefs[0]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl  ml:0 md:justify-start md:ml-16 rounded-3xl ${currentCard === 0 ? 'scale-100 opacity-100' : 'scale-95 opacity-70'}`}
        >
        ...
        <Card 
          ref={cardRefs[1]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl mr-0 md:mr-16 ml-auto rounded-3xl ${currentCard === 1 ? 'scale-100 opacity-100' : currentCard < 1 ? 'scale-95 opacity-50' : 'scale-95 opacity-70'}`}
        >
          <CardContent className="pt-6">
  ...
  />
        ...
        <Card 
          ref={cardRefs[2]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl ml-0 md:ml-16 rounded-3xl ${currentCard === 2 ? 'scale-100 opacity-100' : currentCard < 2 ? 'scale-95 opacity-50' : 'scale-95 opacity-70'}`}
        >
          <CardContent className="pt-6">
        ...
        <Card 
          ref={cardRefs[3]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl mr-0 md:mr-20 p-6 ml-auto rounded-3xl ${currentCard === 3 ? 'scale-100 opacity-100' : 'scale-95 opacity-50'}`}
        >
          <CardContent className="pt-6">
