  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-blue-700">
      ...
      <div className="w-full  space-y-10">
        ...
        <Card 
          ref={cardRefs[1]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl mr-0 md:mr-32 ml-auto rounded-3xl ${currentCard === 1 ? 'scale-100 opacity-100' : currentCard < 1 ? 'scale-95 opacity-40' : 'scale-95 opacity-70'}`}
        >
          <CardContent className="pt-6">
