  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-br from-blue-900 to-green-900">
      ...
      <div className="w-full max-w-3xl space-y-12">
        ...
        <Card 
          ref={cardRefs[0]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl ml-0 rounded-3xl ${currentCard === 0 ? 'scale-100 opacity-100' : 'scale-95 opacity-70'}`}
        >
          <CardContent className="pt-6">
            <h2 className="text-xl font-semibold mb-4 text-white">Personal Information</h2>
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="fullName" className="text-blue-950 font-medium">Full Name</Label>
                <Input 
                  id="fullName" 
                  name="fullName" 
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="text-blue-950 font-medium">Email Address</Label>
                <Input 
                  id="email" 
                  name="email" 
                  type="email" 
              ...
              <div className="space-y-2">
                <Label htmlFor="phoneNumber" className="text-blue-950 font-medium">Phone Number (optional)</Label>
                <Input 
                  id="phoneNumber" 
                  name="phoneNumber" 
        ...
        <Card 
          ref={cardRefs[1]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl mr-0 ml-auto rounded-3xl ${currentCard === 1 ? 'scale-100 opacity-100' : currentCard < 1 ? 'scale-95 opacity-50' : 'scale-95 opacity-70'}`}
        >
          <CardContent className="pt-6">
            <h2 className="text-xl font-semibold mb-4 text-white">School Information</h2>
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="highSchoolName" className="text-blue-800 font-medium">High School Name</Label>
                <Input 
                  id="highSchoolName" 
                  name="highSchoolName" 
              ...
              <div className="space-y-2">
                <Label htmlFor="state" className="text-blue-800 font-medium">State</Label>
                <Select 
              ...
              <div className="space-y-2">
                <Label htmlFor="city" className="text-blue-800 font-medium">City</Label>
                <Select 
                  value={formData.city}
              ...
              <div className="space-y-2">
                <Label htmlFor="graduationYear" className="text-blue-800 font-medium">Graduation Year</Label>
                <Select 
        ...
        <Card 
          ref={cardRefs[2]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl ml-0 rounded-3xl ${currentCard === 2 ? 'scale-100 opacity-100' : currentCard < 2 ? 'scale-95 opacity-50' : 'scale-95 opacity-70'}`}
        >
          <CardContent className="pt-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="race" className="text-blue-800 font-medium">Race</Label>
                <Select 
                  value={formData.race}
        ...
        <Card 
          ref={cardRefs[3]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl mr-0 ml-auto rounded-3xl ${currentCard === 3 ? 'scale-100 opacity-100' : 'scale-95 opacity-50'}`}
        >
          <CardContent className="pt-6">
            <h2 className="text-xl font-semibold mb-4 text-white">Additional Information</h2>
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="firstGeneration" className="text-blue-800 font-medium">First Generation College Student</Label>
