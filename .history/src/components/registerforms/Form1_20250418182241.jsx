...
export default function RegistrationForm() {
          ...
          <CardContent className="pt-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                >
                 <SelectTrigger className={`bg-white/30 placeholder:text-white  ${errors.state ? 'border-red-400' : 'border-white/30'}`}>
  <SelectValue 
  ...
  />
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className={`bg-white/50 text-white placeholder:text-white ${errors.city ? 'border-red-400' : 'border-white/30'}`}>
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className={`bg-white/30 !text-white/70  placeholder:text-white ${errors.graduationYear ? 'border-red-400' : 'border-white/30'}`}>
