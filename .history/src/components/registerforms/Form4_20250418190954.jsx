                ...
                <div key={index} className="space-y-2 bg-white/10 p-3 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    <Input 
                      ...
                      className="bg-white/30 text-white placeholder:text-white/90 border-white/30 w-[91%] ml-10 md:w-[85%]"
                      placeholder="Your role or position"
                    />
                    <Input 
                      value={activity.description}
                      onChange={(e) => handleActivityChange(index, 'description', e.target.value)}
                      className="bg-white/30 text-white placeholder:text-white/90 border-white/30 md:w-[85%]"
