...
export default function RegistrationForm() {
  ...
  />
        ...
        <Card 
          ref={cardRefs[3]}
          className={`bg-white/20 backdrop-blur-md shadow-xl border-0 transition-all duration-300 transform max-w-xl mr-0 md:mr- ml-auto rounded-3xl ${currentCard === 3 ? 'scale-100 opacity-100' : 'scale-95 opacity-50'}`}
        >
          <CardContent className="pt-6">
