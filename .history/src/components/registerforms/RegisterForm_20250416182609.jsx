    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-200/50 to-green-100/50 p-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <Label htmlFor="grade" className="text-blue-950">
              Current Grade
            </Label>
            <Input
              id="grade"
          ...
          <div>
            <Label htmlFor="interests" className="text-blue-950">
              Academic Interests
            </Label>
            <Input
              id="interests"
              ...
              className="bg-white/5 border-white/20 text-blue-950 placeholder:text-white/50"
            />
          </div>
          <div>
            <Label htmlFor="location" className="text-blue-950">
            ...
            <Input
              ...
              className="bg-white/5 border-white/20 text-blue-950 placeholder:text-blue-500/50 !focus:ring-2 focus:ring-blue-500"
            />
          </div>
          <Button
            type="submit"
